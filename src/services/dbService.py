...
async def initDB():
    ...
    await cur.execute("CREATE TABLE IF NOT EXISTS tickets (id INTEGER PRIMARY KEY AUTOINCREMENT, guild TEXT, user TEXT, channel TEXT, ticket_status TEXT NOT NULL DEFAULT \"open\", open_time DATETIME, close_time DATETIME)")
